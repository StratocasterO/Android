package com.pablomonteserin.layouts.tinderlike;
...
public class TinderLike extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tinder_like);

        context = TinderLike.this;
        ...
        for (int i = 0; i < userDataModelArrayList.size(); i++) {
            ...
            final View containerView = inflate.inflate(R.layout.activity_tinder_like_layout, null);
